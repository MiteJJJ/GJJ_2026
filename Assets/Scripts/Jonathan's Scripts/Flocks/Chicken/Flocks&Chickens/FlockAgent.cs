...
public class FlockAgent : MonoBehaviour
{
    ...
    [Header("Fox Flee")]
    public float foxDetectDistance = 5f;
    public float foxSpeedMultiplier = 2.5f;
    bool isNearFox;
    ...
    void CheckFoxProximity()
    {
        ...
        foreach (GameObject f in foxes)
        {
            ...
            diff.y = 0f;
            if (diff.sqrMagnitude < sqrDetect)
            {
                isNearFox = true;
                return;
            }
    ...
    public void Move(Vector3 direction)
    {
        ...
        {
            float force = isNearFox ? normalForce * foxSpeedMultiplier : normalForce;
            Vector3 targetVelocity = dir.normalized * force;
